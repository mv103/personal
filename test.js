...
(function() {
// how do I know which gallery I am choosing from?
  // let carouselNum = this.id; // this needs to be specifc to the carousel slide
  // const carouselSlide = qs('.carousel-slide' + carouselNum);
  const carouselSlide1 = qs('.carousel-slide1');
  const carouselImages1 = qsa('.carousel-slide1 img');
  //Buttons
  const previousBtn1 = qs('#previousBtn1');
  ...
  //Buttons
  const previousBtn2 = qs('#previousBtn2');
  ...
  function init() {
    ...
    previousBtn1.addEventListener('click', prevButton1);

    loadCarousel2();
    nextBtn2.addEventListener('click', nextButton2);
    previousBtn2.addEventListener('click', prevButton2);
  }
...
// set text content, when hover, add class list